...
public class BindingRFIDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_binding_rfid);
        context = this;
    ...
    {
        //1.將輸入的字串轉換成Byte[]
        byte[] textBytes = manuNo.getBytes();
    ...
    boolean writeTag(NdefMessage message, Tag tag)
    {
        ...
        try
        {
            ...
            if(ndef != null)
            {
                ...
                intent.setClass(BindingRFIDActivity.this,checkTaskActivity.class);
